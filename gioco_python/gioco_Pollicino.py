...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.player_index = 0
        self.player_jump = pygame.image.load('D:\sistemi_e_reti\python\giochi\immagini\player\player_salto.png').convert_alpha()
        self.image = self.player_walk[self.player_index]
        self.rect = self.image.get_rect(midbottom = (80, 300))
        self.gravity = 0
        self.jump_sound = pygame.mixer.Sound('D:\sistemi_e_reti\python\giochi\suoni\jump.mp3')
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, type):
        super().__init__()
        if type == 'fly':
            fly_1 = pygame.image.load('D:\sistemi_e_reti\python\giochi\immagini\mosca\mosca.png').convert_alpha()
            fly_2 = pygame.image.load('D:\sistemi_e_reti\python\giochi\immagini\mosca\mosca2.png').convert_alpha()
            self.frames = [fly_1, fly_2]
            y_pos = 210
        else:
            snail_1 = pygame.image.load('D:\sistemi_e_reti\python\giochi\immagini\Lumaca\Lumaca.png').convert_alpha()
            snail_2 = pygame.image.load('D:\sistemi_e_reti\python\giochi\immagini\Lumaca\Lumaca2.png').convert_alpha()
...
'''def collisions(player, obstacles):
    ...
    return True'''
pygame.mixer.init()
fail_sound = pygame.mixer.Sound('D:\sistemi_e_reti\python\giochi\suoni\Fail.mp3')
...
test_font = pygame.font.Font('D:\sistemi_e_reti\python\giochi\Font\Gumball.TTF', 50) #font
game_active = False
start_time = 0
score = 0
#obstacles = 1
...
bg_music = pygame.mixer.Sound('D:\sistemi_e_reti\python\giochi\suoni\BgMusic.mp3')
...
sky_surface = pygame.image.load('D:\sistemi_e_reti\python\giochi\immagini\Test_cielo_corretto.xcf').convert()
ground_surface = pygame.image.load('D:\sistemi_e_reti\python\giochi\immagini\Terreno.png').convert()
...
#menù iniziale
player_stand = pygame.image.load('D:\sistemi_e_reti\python\giochi\immagini\player\player_fermo.png').convert_alpha()
